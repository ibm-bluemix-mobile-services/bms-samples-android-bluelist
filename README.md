...
2. Open Android Studio and open the Android Bluelist Sample by selecting the build.gradle file. File --> Open --> select bms-samples-android-bluelist\bluelist\app\build.gradle.
